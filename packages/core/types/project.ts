...
//   - git_repo: cloud-side git checkout, ref = { url, ref?, default_branch_hint? }.
//     github_repo is the legacy alias for the same shape; both may appear.
//   - local_directory: in-place agent execution on a specific daemon,
//     ref = { local_path, daemon_id, label? }
export type ProjectResourceType = "git_repo" | "github_repo" | "local_directory";
